...
<!DOCTYPE html>
    ...
    <body>
        ...
        ArrayList<RecipeTemp> listRecipe = recipeTempGet.getListRecipe();
        %>
         <%
        ...
        <div class="sidebar">
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
             ...
             <li class="nav-item">
              <a href="manage_recipe_user.jsp" class="nav-link px-2">
                <i class="material-icons icon">
                  view_list
                </i>
        ...
        <main>            
            ...
            <table style="text-align: center;background-color:#00995c;color: white;" width="100%">
                <tr style="font-weight:  bold;">
                    ...
                    <th style="border: 2px solid #dcdcdc;vertical-align: top;color: white">Hình</th>
                ...
                <%
                    int count =0;
                    for(RecipeTemp recipe : listRecipe){
                        count++;
                ...
                <tr  style="text-align: left;">
                    ...
                    <td style="border: 2px solid #dcdcdc;vertical-align: top;"><img style="width:100px; height: 100px;" src="../images/<%=recipe.getRecipeImage()%>"></td>
                ...
                <input type="hidden" name="RecipeId" id="RecipeId" value="<%=recipe.getRecipeId()%>">
                    <td style="border: 2px solid #dcdcdc;vertical-align: top;font-weight:  bold;" width="135px" >
                        <center >
                            ...
                            <a style="color: #ff66cc" href="/chuancommenau/admin/update_check.jsp?recipe_id=<%=recipe.getRecipeId()%>&command=check">   
                               Duyệt
                            </a>&nbsp;| &nbsp;
