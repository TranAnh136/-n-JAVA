...
<html>
    <head>
        ...
        <title>Duyệt bài từ người dùng</title>
         <link
            rel="stylesheet"
      ...
      <div class="content" style="background-color: white;">
        <main>            
            ...
            <div style="background-color: #2D4435">
                <h3  align="center" style="margin-top: 30px;background-color: white;font-weight: bold;"><b>DUYỆT CÔNG THỨC</b></h3>
                <form  action="/chuancommenau/InsertRecipeTemp" method="post" enctype="multipart/form-data">
                    <table width="90%" style="margin-left: 380px;background-color: #2D4435;color: white;">
                      <tr>
                            <td width="125px">
                                <b>Mã công thức</b>
                            </td>
                            <td>
                                <input type="text" id="RecipeId" name="RecipeId" value="<%=recipe.getRecipeId() %>" disabled="disable">
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" id="nameRecipe" name="nameRecipe" size="50" value="<%=recipe.getRecipeName()%>">
                            <br><br>
                            </td>  
                        </tr>
                        <tr>
                            ...
                            <td>
                               <div>
                                    ...
                                    <input type="text" id="catogoryId" name="catogoryId" size="50" value="<%=recipe.getCategoryId()%>">
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="hidden" id="img"  name="img" size="10" value="<%=recipe.getRecipeImage()%>">
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" id="calo" name="calo" size="10" value="<%=recipe.getRecipeCalories()%>">
                            <br><br>
                            </td>
                        </tr>
                       <tr>
                            ...
                            <td>
                                <input type="text" id="userid" name="userid" size="50" value="<%=recipe.getUserIdPostedRecipe()%>">
                            <br><br>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <input type="text" id="author" name="author" size="50" value="<%=recipe.getRecipeAuthor()%>">
                            <br><br>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <textarea cols="100" rows="5" name="ingredients" id="ingredients" ><%= recipe.getIngredientRecipe()%> </textarea>
                            <br><br>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <textarea cols="100" rows="5" name="nuti" id="nuti"><%=recipe.getNutritionIngredients()%></textarea>
                            <br><br>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <textarea cols="100" rows="5" name="making" id="making" ><%=recipe.getMaking()%> </textarea>
                            <br><br>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <textarea cols="100" rows="5" name="descriptionRecipe" id="descriptionRecipe"><%=recipe.getDescriptionRecipe()%></textarea>
                            <br><br>
                            <br><br>
                            </td>
                        </tr>
                      <br><br>
                        <tr>
                            ...
                            <td>
                                <input type="text"  id="video" name="video" size="50" value="https://www.youtube.com/embed/<%=recipe.getVideo()%>">
                                <br>
                                <br>
